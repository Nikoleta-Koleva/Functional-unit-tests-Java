...
public class DogBuddy {
    ...
    public static String howManyWoofs(int numBones) {
        if (numBones <= 0) {
            return "..."; // No bones or negative bones, so silence
        } else if (numBones % 2 == 0) {
            return "Woof! Woof! Woof!"; // Even number of bones, bark three times
        } else {
            return "Woof! Woof!"; // Odd number of bones, bark twice
        }
    }
}
